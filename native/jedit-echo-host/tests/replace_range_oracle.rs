...
fn cases() -> Vec<CaseSpec> {
    vec![
        ...
        obstruction(
            ...
            "invalid-request",
            "did not materialize the declared byte length",
        ),
        obstruction(
        ...
        obstruction(
            "empty-root-nonzero-length-no-op-mask",
            "",
            ...
            SemanticObstructionCode::MalformedRope,
            "invalid-request",
            "basis head byte length does not match root",
        ),
        obstruction(
            "empty-root-nonzero-length-zero-insert",
            "",
            BasisSetup::EmptyRootWithNonzeroLength,
            0,
            0,
