...
acceptance_criteria:
  - The contract defines how point and interval anchors serialize and reload without leaking Echo graph details into the domain law.
...
storage or Echo-specific graph details into the domain contract.
