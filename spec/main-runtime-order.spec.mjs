...
test('main constructs a workspace app and runs it through bijou run()', () => {
  ...
  // Startup instrumentation defaults are proved behaviourally in
  // spec/workspace-startup-instrumentation.spec.mjs, which calls
  // workspaceInstrumentationFromEnv, rather than by grepping this file.
